    ...
    <form @submit.prevent="handleSubmit" class="mt-3">
      <div class="mb-3">
        ...
        <input type="text" class="form-control" v-model="form.name"
          :placeholder="t('article.form.inputs.namePlaceholder')" :class="{ 'is-invalid': form.errors.has('name') }" />
      ...
      <button class="btn btn-primary" :disabled="form.busy">
        <span v-if="form.busy" class="spinner-border spinner-border-sm me-2" role="status" />
